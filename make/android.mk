...
# Path to the Rust workspace inside the submodule
DOTLOTTIE_RS_ROOT ?= deps/dotlottie-rs/dotlottie-rs
...
CRATE_VERSION = $(shell grep -m 1 'version =' $(DOTLOTTIE_RS_ROOT)/Cargo.toml | grep -o '[0-9][0-9.]*')
...
android-aarch64: android-check-ndk
	...
	cargo build \
		--manifest-path $(DOTLOTTIE_RS_ROOT)/Cargo.toml \
	...
	@cp $(DOTLOTTIE_RS_ROOT)/target/$(RUST_TARGET_aarch64)/release/$(ANDROID_LIB_NAME) \
...
android-x86_64: android-check-ndk
	...
	@cp $(DOTLOTTIE_RS_ROOT)/target/$(RUST_TARGET_x86_64)/release/$(ANDROID_LIB_NAME) \
...
android-x86: android-check-ndk
	...
	@cp $(DOTLOTTIE_RS_ROOT)/target/$(RUST_TARGET_x86)/release/$(ANDROID_LIB_NAME) \
...
android-armv7: android-check-ndk
	...
	@cp $(DOTLOTTIE_RS_ROOT)/target/$(RUST_TARGET_armv7)/release/$(ANDROID_LIB_NAME) \
...
android-package:
	...
	@cp $(DOTLOTTIE_RS_ROOT)/build/dotlottie_player.h $(ANDROID_RELEASE_DIR)/include/
